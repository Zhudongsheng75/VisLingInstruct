...
from vislinginstruct.datasets.builders.base_dataset_builder import BaseDatasetBuilder

from vislinginstruct.common.registry import registry
from vislinginstruct.datasets.datasets.aok_vqa_datasets import AOKVQADataset, AOKVQAEvalDataset, VQGAOKVQADataset
from vislinginstruct.datasets.datasets.coco_vqa_datasets import COCOVQADataset, COCOVQAEvalDataset, VQGCOCOVQADataset
from vislinginstruct.datasets.datasets.ocr_vqa_dataset import OCRVQADataset, STVQADataset, DocVQADataset
from vislinginstruct.datasets.datasets.llava_dataset import LLAVA150kDataset
...
@registry.register_builder("llava_instruct_150k") 
class LLAVA150kBuilder(BaseDatasetBuilder):
    train_dataset_cls = LLAVA150kDataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/llava/finetune_150k.yaml",
    }
    ...
    def build_datasets(self):
        ...
        datasets['train'] = dataset_cls(
            vis_processor=self.vis_processors["train"],
            text_processor=self.text_processors["train"],
            ann_paths=[os.path.join(storage_path, 'llava_instruct_150k.json')], 
            vis_root=vis_root,
        )
