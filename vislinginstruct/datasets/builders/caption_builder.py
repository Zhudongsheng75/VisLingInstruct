...
from vislinginstruct.datasets.datasets.coco_caption_datasets import (
    COCOCapDataset,
    COCOCapEvalDataset,
    NoCapsEvalDataset,
)

from vislinginstruct.datasets.datasets.caption_datasets import TextCapsDataset, CaptionDataset, LLaVAPretrainDataset, CC3MDataset
...
class LLaVAPretrainBuilder(BaseDatasetBuilder):
    ...
    def build_datasets(self):
        ...
        datasets['train'] = dataset_cls(
            ...
            ann_paths=[os.path.join(storage_path, 'llava_pretrain_0.05.json')], 
            vis_root=vis_root,
        )
...
class CC3MBuilder(BaseDatasetBuilder):
    ...
    def build_datasets(self):
        ...
        datasets['train'] = dataset_cls(
            vis_processor=self.vis_processors["train"],
            text_processor=self.text_processors["train"],
            # ann_paths=[os.path.join(storage_path, 'chat.json')],
            ann_paths=[os.path.join(storage_path, 'chat_0.05.json')], 
            vis_root=vis_root,
        )
