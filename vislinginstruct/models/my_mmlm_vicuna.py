...
class MyMMLMVicunaInstruct(Blip2Base):
    ...
    Supported model types:
        ...
        - vicuna13b
    Usage:
        >>> from vislinginstruct.models import load_model
    ...
    def __init__(
        ...
        from vislinginstruct.models.modeling_llama import LlamaForCausalLM
    ...
    def forward(self, samples):
        ...
        #                                 dim=1)
        # inputs_llm = self.llm_proj(inputs_llm_proj)
    ...
    def _predict_class(
        ...
        with self.maybe_autocast(dtype=torch.bfloat16):
            ...
            for n in range(n_segments):
                ...
                all_losses += loss
                # del loss, inputs_embeds, attention_mask, outputs
        ...
        # del query_output, inputs_llm, all_losses, candidates, samples, image_embeds
        # torch.cuda.empty_cache()
